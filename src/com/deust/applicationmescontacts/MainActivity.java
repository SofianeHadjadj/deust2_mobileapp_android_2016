...
public class MainActivity extends Activity {
 ...
 public void onCreate(Bundle savedInstanceState) {
  ...
  contactList.add(contact);
  contact = new Contact("Laforest Stéphane","0666666666",false);
  contactList.add(contact);
  contact = new Contact("Dupont Antoine","0677777777",false);
  contactList.add(contact);

  
  //Etape 5: Récupérer la liste des contacts du téléphone et remplacer la liste de contacts à cocher par celle-ci.
  Contact contactel;
 ...
 private void checkButtonValiderClick() {
  ...
  myButton.setOnClickListener(new OnClickListener() {
   ...
   public void onClick(View v) {
    ...
    responseText.append("Les contacts selectionnées:\n");  
    
    // Etape 4 : Récupérer la liste des contacts selectionnés.
    ...
    if(mylist.size()==0)
    {
        Toast.makeText(getApplicationContext(),
        	      "Pas de contacts selectionnées", Toast.LENGTH_LONG).show();
